...
RUN dnf install -y systemd inotify-tools curl git lazygit fish tmux fzf fd-find ripgrep bat perl-Image-ExifTool gh zoxide jq gcc openssl-devel eza tealdeer ncdu
